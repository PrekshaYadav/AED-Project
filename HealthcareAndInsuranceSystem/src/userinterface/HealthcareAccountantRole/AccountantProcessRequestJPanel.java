...
public class AccountantProcessRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtPayableAmount.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        txtInsuranceClaimAmount.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        txtInsurancePolicyName.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
    ...
    private void btnSendRequestForInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendRequestForInsuranceActionPerformed
        ...
        insuranceWorkRequest.setCustSSN(ssn);
        ...
        insuranceWorkRequest.setInsuranceCustomer(accountBillingRequest.getPatient().getInsuranceCustomer());
        ...
        for (Organization organization : matchedInsuranceCompany.getOrganizationDirectory().getOrganizations()) {
            if (organization instanceof InsuranceBrokerOrganization) {
                org = organization;
                break;
            }
        }
...
//        backJButton.setBackground(new Color(13, 17, 23));
    ...
    private void sendEmail() {
        ...
        properties.put("mail.smtp.from", "clinic.scp5100@gmail.com");
        properties.put("mail.smtp.auth", "true");
        properties.put("mail.smtp.port", "465");

        Session session = Session.getDefaultInstance(properties, new javax.mail.Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new javax.mail.PasswordAuthentication("clinic.scp5100@gmail.com", "Info@5100");
            }
        });

        try {
            MimeMessage message = new MimeMessage(session);
            message.setFrom(new InternetAddress("clinic.scp5100@gmail.com"));
