...
public class InsuranceFinanceManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private InsuranceFinanceTeamOrganization insuranceFinanceOrganization;
    private Enterprise enterprise;
    private DB4OUtil dB4OUtil;
    private EcoSystem ecosystem;
    
    public InsuranceFinanceManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, InsuranceFinanceTeamOrganization insuranceFinanceOrganization, Enterprise enterprise,DB4OUtil dB4OUtil,EcoSystem ecosystem) {
        initComponents();
