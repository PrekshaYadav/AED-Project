...
public class AllInsuranceRequestsJPanel extends javax.swing.JPanel {
    ...
    private InsuranceBrokerOrganization insuranceAgentOrganization;

    public AllInsuranceRequestsJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, InsuranceBrokerOrganization insuranceAgentOrganization) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : insuranceAgentOrganization.getWorkQueue().getWorkRequests()) {
            ...
            row[1] = ((InsuranceWorkRequest) request).getInsuranceCustomer().getCustFirstName() + " " + ((InsuranceWorkRequest) request).getInsuranceCustomer().getCustLastName();
