 ...
 * 
 */
public class GovernmentTreasurerProcessWorkRequestJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    private GovernmentFundRequest governmentFundRequest;

    public GovernmentTreasurerProcessWorkRequestJPanel(JPanel jPanel, GovernmentFundRequest fundRequest) {
        initComponents();
...
//        submitJButton.setBackground(new Color(13, 17, 23));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (message.equals("")) {
            ...
            GovernmentTreasurerWorkAreaJPanel dwjp = (GovernmentTreasurerWorkAreaJPanel) component;
            dwjp.populateTable();
            CardLayout layout = (CardLayout) jPanel.getLayout();
            layout.previous(jPanel);
