 ...
 * 
 */
public class GovernmentTreasurerWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form GovernmentTreasurerWorkAreaJPanel
     */
    private JPanel jPanel;
    private UserAccount userAccount;
    private GovernmentTreasurerOrganization treasurerOrganization;
    private Enterprise enterprise;
    private DB4OUtil dB4OUtil;
    private EcoSystem ecoSystem;

    public GovernmentTreasurerWorkAreaJPanel(JPanel jpanel, UserAccount userAccount, Organization organization, Enterprise enterprise, DB4OUtil dB4OUtil, EcoSystem ecosystem) {
        initComponents();
        this.enterprise = enterprise;
        this.jPanel = jpanel;
        this.treasurerOrganization = (GovernmentTreasurerOrganization) organization;
...
//        btnCompleteDelivery.setBackground(new Color(22, 27, 34));
    ...
    private void btnCompleteDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompleteDeliveryActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            GovernmentTreasurerProcessWorkRequestJPanel treasurerProcessWorkRequestJPanel = new GovernmentTreasurerProcessWorkRequestJPanel(jPanel, request);
