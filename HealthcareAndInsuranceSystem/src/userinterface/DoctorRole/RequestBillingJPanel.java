...
public class RequestBillingJPanel extends javax.swing.JPanel {
    ...
    RequestBillingJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, PatientTreatmentWorkRequest workRequest) {
        ...
        txtMedicationCharges.setText(String.valueOf(Math.floor(workRequest.getMedicationCharges())));
        populateTable();
    ...
    private void initComponents() {
        ...
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(466, 705, 282, -1));
        ...
        txtPatientId.setBackground(java.awt.Color.white);
        txtPatientId.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        txtFirstName.setBackground(java.awt.Color.white);
...
//        jLabel9.setFont(new Font(jLabel9.getFont().getName(), Font.PLAIN, 19));
    }//GEN-LAST:event_jLabel9MouseEntered

    private void jLabel9MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseExited
        // TODO add your handling code here:

//        jLabel9.setFont(new Font(jLabel9.getFont().getName(), Font.PLAIN, 18));
