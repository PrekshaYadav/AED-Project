...
public class InsuranceArchitectWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private InsuranceArchitectOrganization insurancePolicyPlannerOrganization;
    private InsuranceEnterprise insuranceCompanyEnterprise;
    private DB4OUtil dB4OUtil;
    private EcoSystem ecosystem;

    public InsuranceArchitectWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, InsuranceArchitectOrganization insurancePolicyPlannerOrganization, Enterprise enterprise, DB4OUtil dB4OUtil, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(btnLogoutPatient, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 10, -1, -1));
